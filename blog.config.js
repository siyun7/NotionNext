...
const BLOG = {
  AUTHOR: 'Qi', // 作者
  BIO: '记录程序猿的各种疑难杂症', // 作者简介
  LINK: 'https://blog.ltq.im', // 网站地址
  KEYWORDS: 'Notion, 博客, 程序员', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'e05ee37d712d44228ac2a945f5aca2eb', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'i@ltq.im',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/siyun7',
  CONTACT_TELEGRAM: '',
  ...
  AVATAR: 'https://avatars.githubusercontent.com/u/20219516', // 作者头像，被notion中的ICON覆盖。如果没有ICON则取public目录下的avatar.png
